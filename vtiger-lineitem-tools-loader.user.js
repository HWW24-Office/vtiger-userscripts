...
(async function () {
  ...
  try {
    ...
    script.onload = () => {
      ...
      console.log('[HW24 Loader] vtiger-lineitem-tools.user.js loaded successfully');
    };
    script.onerror = () => {
      URL.revokeObjectURL(blobUrl);
    ...
    console.error('[HW24 Loader] Failed to load vtiger-lineitem-tools.user.js:', err.message);
  }
})();
